...
export interface ClassroomTrace { version: number; sessionId: string; nodes: ThoughtNode[]; edges: z.infer<typeof ThoughtEdgeSchema>[]; parent?: string; branches: { sessionId: string; title: string; parent?: string }[] }
