...
import { registerClassmateDraft } from '../plugins/classmate-draft.ts';
...
export async function apply(ctx: Context): Promise<void> {
  ...
  ctx.plugin({ inject: ['slots', 'sessions', 'layout', 'conversation', 'inputTriggers', 'sidebarRight', 'remote.studyforgeTrace', 'remote.studyforgeLibrary', 'remote.studyforgeCreation', 'remote.studyforgeCourses', 'remote.studyforgeMaterials', 'remote.studyforgeTeaching', 'remote.studyforgeMemory', 'remote.studyforgeLearning', 'remote.studyforgeOrganization', 'remote.studyforgeHandoffs', 'remote.studyforgeProposals', 'remote.studyforgePlugins', 'remote.studyforgeRounds', 'remote.notaraWorkbench', 'remote.notaraClassroomView', 'remote.studyforgeVault'], apply: registerLearningWorkspace });
