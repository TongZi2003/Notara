...
const PRIMARY = ['studyforge.home', 'studyforge.sets', 'studyforge.courses', 'studyforge.materials', 'studyforge.calendar', 'studyforge.memory', 'studyforge.teaching', 'studyforge.plugins'];
