...
日常默认只保留[世界书](../../examples/plugins/worldbook/README.md)作为课堂背景能力。数学工作台、回合、Seminar 和其他工作台是实验能力，代码和测试样本继续保留，但不进入默认课堂的 UI、提示词或模型工具集合。完整路线规划、对话内路线图和只读子智能体仍属于默认课堂能力。
