...
const FORBIDDEN_STUBS = ['query_evidence', 'read_memory', 'record_review', 'propose_review', 'update_card', 'register_cards', 'propose_card', 'note_method', 'revise_method', 'write', 'edit', 'read', 'glob', 'grep', 'read_image', 'bash', 'subagent', 'propose_route'] as const;
